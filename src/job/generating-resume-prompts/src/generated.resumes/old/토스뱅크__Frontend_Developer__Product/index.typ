...
#grid(
    ...
    [
        ...
        #additional_title("더욱 쉽게 사용할 수 있도록 만드는 프론트엔드 개발자")
        #v(rem(2))
...
입시 학원 강사 시절, 진도와 오답 관리 시스템을 만들었지만 CLI 기반이라 다른 강사들이 사용하기 어려웠습니다.
사용자(강사)의 업무 흐름을 분석한 후 웹앱으로 재설계했습니다. 칸반 보드로 진도를 시각화하고, 그리드 체크박스로 오답을
빠르게 체크할 수 있게 하여 실제 수업 흐름에 맞는 인터페이스를 구현했습니다.

사용자 경험에는 성능이 중요합니다. PDF 생성 시간을 61.3% 단축하고 서버 응답 시간을 22배 향상하는 등, 사용자의 흐름이
막히지 않는 데에 집중했습니다.

사용자가 경험하는 전체 흐름을 이해하고, 더 편리한 방향으로 개선하는 개발자입니다. 토스뱅크의 금융 서비스 사용자 경험
개선에 기여하고 싶습니다.
