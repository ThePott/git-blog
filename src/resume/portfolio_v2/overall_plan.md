...
- 표지
- 도구는 본질이 아니다. 기술 스택을 굳이 쓸 필요는 없어보인다.
- Arbor The Tree 오답 관리 시스템을 만들며 해결한 본질적 문제
    - 문제 파악
        - 일반 수업에서의 문제
        - 당시 내 시스템에서의 문제
        - 원장의 요구사항
    - 문제 1: 문제집 등록 시 스프레드 시트가 필요
        - 표면: 구글 시트가 익숙한데 필요한 기능이 있는 라이브러리는 유료다
        - 본질: 자동완성이 되기만 하면 된다. 구글 시트의 방식으로 될 필요는 없다.
            - 유효성 검사를 내장. 더 쉽게 관리
    - 문제 2: pdf 생성하기
