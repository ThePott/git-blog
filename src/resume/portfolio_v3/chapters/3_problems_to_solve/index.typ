...
#let problems_to_solve = [
    ...
    #pagebreak()
    #title-section((level: 1, size: "lg", title: "Arbor The Tree 진도 관리 시스템으로 해결하려고 한 문제"))
    #title-section((level: 2, size: "sm", title: "1. 입시 학원의 문제"))
    - 강사 기억에 의존한 진도 추적
    ...
    #pagebreak()
    #title-section((level: 1, size: "lg", title: "Arbor The Tree 진도 관리 시스템으로 해결하려고 한 문제"))
    #title-section((level: 2, size: "sm", title: "2. 구글 시트 + 파이썬 시스템의 문제"))
    - 이를 해결하려 파이썬과 구글 시트로 진도 관리 시스템 제작
    - CLI로 제작되어 사용자 친화성 부족
        - 다른 강사들이 사용하지 못함
    - 병렬적 자료 생성, 직렬적 동기화로 병목 현상 발생
    ...
    #pagebreak()
    #title-section((level: 1, size: "lg", title: "Arbor The Tree 진도 관리 시스템으로 해결하려고 한 문제"))
    #title-section((level: 2, size: "sm", title: "3. 고객의 요구사항"))
    - 빠른 반응 속도 요구
    - 쉬운 조작법 요구
