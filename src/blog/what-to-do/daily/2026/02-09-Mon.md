...
- [ ] bulk update logic
- [ ] info 에 question id 넣은 것 삭제 <- dict의 key 값으로 해결해야
- [ ] bulk update optimistic update
- [ ] debounce -> 한 번에 요청, 한 번에 optimistic
- [ ] changed series가 {}이 아닐 땐 버튼을 초록색으로 강조
- [ ] refactore
- [ ] TODO: client re-route
