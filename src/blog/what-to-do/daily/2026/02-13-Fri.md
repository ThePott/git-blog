...
- [ ] client에게 필요한 정보만 넘기도록 get assignment 수정 - assigned_at, book_title_array, question_count,
      completed_at만 필요
- [ ] client에서 타입 수정
- [ ] 표 정상 출력
...
- [ ] typst cli setup
- [ ] typst sample page for review assignment
- [ ] create typst file from node
- [ ] typst compile to pdf then save it to debug in node << how can I run system command in node?
- [ ] create blob from pdf
- [ ] can I create pdf and convert into blob without saving it?
