...
- [x] create grouped boxes with topic, step
- [x] add page line
- [x] make topic, step, page sticky
- [x] add bar placeholder
- [x] include status, toggle, submit button <- no functionality
- [x] create create-page-specific store
- [x] refactor review check create page

#### create review check

- [x] client setup for api
- [x] blank api
- [x] api logic
- [x] actually request from client
- [ ] join when respond
- [ ] add join type in client
- [ ] apply join type in loader
- [ ] apply join type in ui
