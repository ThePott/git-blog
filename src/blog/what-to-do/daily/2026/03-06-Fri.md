...
- [ ] 스토어에 triggerref 넘기는 방법 확인 << local auto complete 봐보자
- [ ] select 구조 변경 -> optionArray 받도록

### replace auto complete to local one

- [ ] LocalAutoComplete으로 교체 << 이게 더 빠릿하다
...
## dropdown popper 이용해서 방향 맞추기

## 조교 권한 만들기

- [ ] 어떻게 하지?? 현재는 user_id로 검사하는데... principal_user_id 받아서 이걸 이용해?? 어떻게하지?? <<<< 물어보기
